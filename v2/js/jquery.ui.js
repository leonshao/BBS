// define(["jquery1.5"], function(require) {
// var jQuery = require("jquery1.5");
/*!
 * jQuery UI 1.8.14
 *
...
(function(d, C) {
    ...
    function N(a) {
        return a.bind("mouseout", function(b) {
            ...
            if (!(d.datepicker._isDisabledDatepicker(J.inline ? a.depend()[0] : J.input[0]) || !b.length)) {
